...
class Extender(Detector):
    ...
    def inference(self, horizon, n_steps=30, batch_size=128, crop_shape=(1, 64, 64),
                  stride=16):
        ...
        for _ in self.make_pbar(range(n_steps), desc=f'Enhancer inference on {horizon.name}'):
    ...
    def get_train_template(self):
        ...
        return load + filter_out + augment + train
